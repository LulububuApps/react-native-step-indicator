...
export default class StepIndicator extends PureComponent {
    ...
    renderProgressBarBackground = () => {
        ...
        if (direction === 'vertical') {
            progressBarBackgroundStyle = {
                ...
                position:        'absolute',
                left:            (
                                     this.state.width - this.customStyles.separatorStrokeWidth
                                 ) / 2,
            ...
            progressBarBackgroundStyle = {
                ...
                position:        'absolute',
                top:             (
                                     this.state.height - this.customStyles.separatorStrokeWidth
                                 ) / 2,
    ...
    renderStepLabels = () => {
        ...
        var labelViews                               = labels.map((label, index) => {
            const selectedStepLabelStyle = index
            === currentPosition ? { color: this.customStyles.currentStepLabelColor } : { color: this.customStyles.labelColor }
            return (
                <TouchableWithoutFeedback style={styles.stepLabelItem}
                                          key={index}
